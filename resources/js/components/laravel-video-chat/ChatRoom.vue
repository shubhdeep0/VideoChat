                        ...
                        <ul class="chat" v-chat-scroll>
                            ...
                            <span class="chat-img" v-bind:class="{ 'pull-right' : check(message.sender.id) , 'pull-left' : !check(message.sender.id) }">
                                ...
                                <div class="chat-body clearfix">
                                    <div class="header">
                                        <small class=" text-muted"><span class="glyphicon glyphicon-time"></span>3468734657634878345</small>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            send() {
                axios.post('/video_chat/public/chat/message/send',{
            ...
            sendFiles() {
                ...
                axios.post('/video_chat/public/chat/message/send/file', data);
            },
    ...
    function onCreateAnswerSuccess(desc) {
        ...
        axios.post('/video_chat/public/trigger/' + conversationID , message );
    }
